...
class Slicer{
    ...
    const DEBUG = false;
    const CURAENGINE_PATH = "./Cura/CuraEngine.exe";
    const KISSLICER_PATH = "./KISSlicer/KISSlicer64.exe";
    const KISSLICER_CONFIG_PATH = "./KISSlicer/_styles.ini"; //KISSlicer requires a config file in addition to command-line arguments
    const SLIC3R_PATH = "./Slic3r/slic3r.exe";
    const JAVA_PATH = "/Library/Java/JavaVirtualMachines/jdk-12.0.1.jdk/Contents/Home/bin/java.exe";
    const GCODEINFO_PATH = "./GCodeInfoV99.jar";
